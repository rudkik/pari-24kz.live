        ...
        <button class="btn-self {{ request()->is('live') ? '_js-active' : '' }}" type="button" aria-label="кнопка" data-r-btn="a1" onclick="window.location.href='/live'">Live</button>
			...
			<article class="spoiler  leagues__sect _js-active" data-sel-target="">
              ...
              <div class="spoiler__hide">
				...
				@if ($arr_res_sport == null)
					Данные не загружены
				@else
                  @foreach($arr_res_sport as $arr_res_spor)
                            <li class="list-leag__box-itm">
                              <a class="list-leag__itm" href="/bets/{{$arr_res_spor['id_sport']}}?category=live"> <span class="list-leag__ico">
                                <picture>
            ...
            <article class="spoiler leagues__sect _js-active"  data-sel-target="">
              ...
              <div class="spoiler__hide">
				...
				@else
                        ...
                        <li>
                          <a class="list-leag__itm" href="/bets/{{$data_leage['sport_id']}}/{{$data_leage['id_tourn']}}?category=live"> <span class="list-leag__ico">
                            <picture>
