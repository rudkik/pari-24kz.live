...
<div>
            <section class="match _ibg p__match"><picture><source srcset="img/grass.avif" type="image/avif"><source srcset="img/grass.webp" type="image/webp"><img class="_ibg-img" src="img/grass.jpg" loading="lazy" width="100" height="100" alt="img"></picture>
              <h2 class="match__ttl"> Настольный теннис. Сетка Кап</h2>
              <article class="match__info info-match">
                <h6 class="info-match__name">Сергей Малюк (Укр)</h6>
                <div class="info-match__time"><span>18:00</span><span class="info-match__date">11.12</span></div>
                <h6 class="info-match__name">Олег Куриленко (Укр)</h6>
              </article>
            ...
            <section class="desgn-bet">
              ...
              <div class="desgn-bet___table-a table-adb">
                <div class="table-adb__clm">
                  <h6 class="table-adb__ttl"> Сергей Малюк (Укр)</h6><span class="table-adb__val table-adb__val--l">13.2</span>
                </div>
                <div class="table-adb__clm">
                  <h6 class="table-adb__ttl table-adb__ttl--cntr"> Ничья</h6><span class="table-adb__val">13.2</span>
                </div>
                <div class="table-adb__clm">
                  <h6 class="table-adb__ttl"> Олег Куриленко (Укр)</h6><span class="table-adb__val table-adb__val--r"> 13.2</span>
                </div>
              </div>
              <div class="desgn-bet__game-box"><span class="desgn-bet__display">Итоговый коэффициент: 138.8</span>
                <article class="switch-dsb">
                  <button class="switch-dsb__btn" type="button" aria-label="кнопка">-</button>
                  <h6 class="switch-dsb__val">100</h6>
                  <button class="switch-dsb__btn" type="button" aria-label="кнопка">+</button>
                </article>
              </div>
              <button class="btn desgn-bet__btn" type="button" aria-label="кнопка"> Сделать ставку</button>
            </section>
          </div>
