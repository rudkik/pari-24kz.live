(() => {
        ...
        if (
          ...
          this.options.hashSettings.location &&
            ...
            this._reopen
              ...
              : !this.bodyLock &&
                ((e = 500) => {
                  if ((document.querySelector("body"), l)) {
    ...
    formClean(t) {
      t.reset(),
        setTimeout(() => {
          ...
          if (l.length > 0)
            for (let e = 0; e < l.length; e++) l[e].checked = !1;
          if (e.select) {
  ...
  function a() {
    ...
    !(function () {
      const e = document.documentElement,
        t = document.querySelectorAll('[data-burger="header"]');
      t.length > 0 &&
        t.forEach((t) => {
          t.addEventListener("click", function (t) {
            e.classList.toggle("_js-burger-open");
          });
        });
    })(),
      (function (e, t) {
        ...
        l.length > 0 &&
          l.forEach((e) => {
            e.addEventListener("click", function (t) {
              let l = e.getAttribute(s),
                i = document.querySelector(`[ data-go-target='${l}']`);
              i
                ? i.classList.toggle("_js-active")
                : console.log("📢  не найдена цель Go2 📢 ");
            });
          });
      })(),
      (function (e, t) {
        const s = document.querySelectorAll("[ data-r-btn]");
        s.length > 0 &&
          s.forEach((e) => {
            e.addEventListener("click", function (t) {
              let s = e.getAttribute("data-r-btn");
              document.querySelectorAll(`[ data-r-btn='${s}']`).forEach((e) => {
                e.classList.toggle("_js-active");
              });
            });
          });
      })(),
      (function (e, t) {
        const s = document.querySelectorAll("[ data-btn-sel]");
        s.length > 0 &&
          s.forEach((e) => {
            e.addEventListener("click", function (t) {
              let s = e.closest("[ data-sel-target]");
              s && s.classList.toggle("_js-active");
            });
          });
      })(),
      (function (e, t) {
        ...
        if (o) {
          const e = o.querySelectorAll(`[ ${i}]`),
            t = o.querySelectorAll(`[ ${l}]`);
          o.addEventListener("click", function (a) {
            if ((console.log("📢   📢 "), a.target.closest(`[ ${i}]`))) {
              e.forEach((e) => {
              ...
              let c = a.target;
              c.classList.add(s);
              let n = c.getAttribute(i);
              o.querySelector(`[ ${l}='${n}']`).classList.add(s);
            }
          });
        }
      })(0, e);
  ...
  (e.select = new (class {
    ...
    selectInit(e, t) {
      ...
      if (e.classList.contains("select-ignore")) return;
        ...
        return `<div class="${this.selectClasses.classSelectTitle}"><span${l} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${s}" data-placeholder="${s}" class="${this.selectClasses.classSelectInput}"></span></div>`;
      {
        const e =
          ...
          this.getSelectedOptionsData(t).elements[0].dataset.class
            ? ` ${this.getSelectedOptionsData(t).elements[0].dataset.class}`
            : "";
        return `<button type="button" class="${this.selectClasses.classSelectTitle}"><span${l} class="${this.selectClasses.classSelectValue}${i}"><span class="${this.selectClasses.classSelectContent}${e}">${s}</span></span></button>`;
      }
    }
    ...
    getOption(e, t) {
      ...
      return (
        (c += o
          ? `<a ${a} ${l} href="${o}" data-value="${e.value}" class="${this.selectClasses.classSelectOption}${i}${s}">`
    ...
    setLogging(e) {
      this.config.logging && i(`[select]: ${e}`);
    }
  })({})),
